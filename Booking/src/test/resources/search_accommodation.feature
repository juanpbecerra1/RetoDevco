Feature: Search Accommodation
  ...
  Scenario Outline: Search Accommodation
    ...
    Examples:
      ...
      | Cartagena de Indias | 05-September-2021 | 10-September-2021 | accommodations found                                                   |
      | Santa Marta         | 05-September-2021 | 10-November-2021  | Sorry, it is not possible to make reservations for more than 30 nights |
